package com.adobe.ac.samples.view.pmodel
{
	...
	public class MainModel 
	{
		...
		[Bindable]
		public var availableI18n:ArrayCollection = new ArrayCollection(
			[ new I18nDescriptor("fr","FR"), 
				new I18nDescriptor("en","US"),
				new I18nDescriptor("nb","NO"),
				new I18nDescriptor("it","IT"),
				new I18nDescriptor("pt","BR")  ]);
		[Bindable]
		public var currentI18n:I18nDescriptor;
		...
		{
			this.switchLocale(new I18nDescriptor("fr","FR"));
			this.todoItem = null;
		...
		{
			this.currentI18n =  I18nDescriptor(locale)
			ResourceManager.getInstance().localeChain = [ currentI18n.locale ];
			this.status = "Locale changed to "+currentI18n.locale;			
		}
