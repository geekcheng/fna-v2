...
<c:set var="swf" value="${not empty swf ? swf : 'index'}"/>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            swfobject.embedSWF("${ctx}/${swf}.swf", "${application}_div", "${width}", "${height}", "${version_major}", "expressInstall.swf", flashvars, params, attributes);
