<%--
  This groovy template file finds its root in GRANITE DATA SERVICES
...
--%>/**
 * Generated by FlexMojos/Gas3 v${gVersion}.
 *
 * NOTE: this file was generated but it is not used/included in the packaged library
 *       as we chose to have the extended dto in another lib
 */
