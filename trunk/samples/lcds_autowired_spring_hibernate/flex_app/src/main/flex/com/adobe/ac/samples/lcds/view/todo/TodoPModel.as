package com.adobe.ac.samples.lcds.view.todo
{
   ...
   import com.adobe.ac.samples.lcds.model.TodoList;
   ...
   public class TodoPModel 
   {
	...
	public var todoItem:TodoItem;
      ...
      {
      	new CreateTodoItemEvent(this).dispatch();
      }
      public function onResultCreateItem(event:Object):void
	  {
    	this.status = "Item ("+this.todoItem.id+") successfully created";
    	new GetTodoListEvent(this).dispatch();// to reset and refresh the dataGrid items
	  }
	  public function onFaultCreateItem(event:Object):void
	  {
    	this.status = "Creation failed ! ("+event.toLocaleString()+")";
	  }
