 ...
 * 
 * @version $Id: AbstractNcssReportGenerator.java 3286 2007-02-08 20:18:51Z jeanlaurent $
 */
public abstract class AbstractNcssReportGenerator
{
     ...
     */
    protected AbstractNcssReportGenerator( final Sink sink, final ResourceBundle bundle, final Log log )
    {
        this.bundle = bundle;
        this.sink = sink;
        this.log = log;
